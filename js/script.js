...
// Globale Variabelen
  var divStringAnalyse;
  var txtIngave;
  var divNumberVoorbeeld;
  var divMathVoorbeeld;
  var divObjectVoorbeeld;
...
function Initieer() {
  ...
  divStringAnalyse = document.getElementById('divStringAnalyse');
  txtIngave = document.getElementById('txtIngave');
  btnStringAnalyseer = document.getElementById('btnStringAnalyseer');
  divNumberVoorbeeld = document.getElementById('divNumberVoorbeeld');
  divMathVoorbeeld = document.getElementById("divMathVoorbeeld");
  divObjectVoorbeeld = document.querySelector("#divObjectVoorbeeld");
...
function ToonObjectVoorbeeld(){
  let berg = {"Naam" : "Tourmalet", "Land" : "Frankrijk", "Hoogte" : 2115, "Opgefietst" : false};
